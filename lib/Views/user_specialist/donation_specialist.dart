...
import 'package:url_launcher/url_launcher.dart';
  ...
  class DonationSpecialist extends StatefulWidget {
  const DonationSpecialist({Key? key}) : super(key: key);

  @override
  State<DonationSpecialist> createState() => _DonationSpecialistState();
}

class _DonationSpecialistState extends State<DonationSpecialist> {
